...
//—————「 Set Nama Own & Bot 」—————//
global.ownername = 'IKYY MAKERZ' //ubah jadi nama mu, note tanda ' gausah di hapus!
global.botname = 'IKYY MAKERZ' //ubah jadi nama bot mu, note tanda ' gausah di hapus!
global.footer = 'IKYY MAKERZ' //ubah jadi nama mu, note tanda ' gausah di hapus!
//=================================================//
// Other
global.owner = ['6281364011418']
global.premium = ['6281364011418']
global.packname = '𝙄𝙆𝙔𝙔 𝙈𝘼𝙆𝙀𝙍𝙕'
global.ownerr = ['IKYY MAKERZ']
global.author = 'IKYY MAKERZ'
global.sessionName = './sessionye/haikal'
global.prefa = ['','!','.',',','🐤','🗿']
global.sp = '⭔'
global.mess = {
    nsfw: '*Fitur NSFW tidak diaktifkan, chat admin grup supaya diaktifkan*_',
    wait: '*Loading... SABAR YA MEK🗿*_',
    private: 'Fitur Digunakan Hanya Untuk Private Chat!',
    bot: 'Fitur Khusus Pengguna Nomor Bot',
    endLimit: 'Limit Harian Anda Telah Habis, Limit Akan Direset Setiap Jam 12',
    verif: 'Hai Kakak 👋 Silahkan Verifikasi Terlebih Dahulu Agar Bisa Menggunakan Ikyy makerz',
}
//=================================================//
